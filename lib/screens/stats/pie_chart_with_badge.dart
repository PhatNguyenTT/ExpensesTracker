...
class PieChartWithBadge extends StatefulWidget {
  const PieChartWithBadge({super.key});
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge('assets/icons/ophthalmology-svgrepo-com.svg',
        ...
        case 1:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge('assets/icons/librarian-svgrepo-com.svg',
                size: widgetSize, borderColor: Colors.black),
            badgePositionPercentageOffset: .98,
          );
        case 2:
        ...
        default:
          throw Exception('Không có phần tử phù hợp!');
      }
    });
  }
}
